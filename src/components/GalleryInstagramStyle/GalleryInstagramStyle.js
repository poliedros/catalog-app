...
const GalleryInstagramStyle = () => {
  ...
  return (<div className="example">
      ...
      <ZoomSlider slides={slides} initialSlide="0"/>
      <p>
...
GalleryInstagramStyle.propTypes = {};

GalleryInstagramStyle.defaultProps = {};

export default GalleryInstagramStyle;
